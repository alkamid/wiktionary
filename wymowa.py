...
def main():
	...
	popularList = []
	popularFile = codecs.open('%sscripts/output/visits.txt' % config.path['scripts'], encoding='utf-8')
	...
	site_co = pywikibot.getSite('commons', 'commons')
	...
	for page in lista_main:
		...
		for retry in retryloop(5, timeout=30):
			try:
				pywikibot.ImagePage(site, u'Pl-%s.ogg' % page.title()).fileIsOnCommons()
